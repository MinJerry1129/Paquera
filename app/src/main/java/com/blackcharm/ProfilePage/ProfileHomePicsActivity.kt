...
import kotlinx.android.synthetic.main.activity_my_profile_homepics.*
import java.io.ByteArrayOutputStream
import java.util.*

class ProfileHomePicsActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_my_profile_homepics)

        //**********Show back button on top toolbar**********

        val toolbar: androidx.appcompat.widget.Toolbar = findViewById(R.id.myprofile_homepics_toolbar);
        ...
        var recyclerview_contacts_type = findViewById<RecyclerView>(R.id.recyclerview_profile_homepics)
       ...
       // recyclerview_contacts_type.addItemDecoration(DividerItemDecoration(this, DividerItemDecoration.HORIZONTAL))
        ...
        getProfileHomeImages(this)

        profile_add_new_homephoto.setOnClickListener {
...
//
                ...
                val ref1 = FirebaseDatabase.getInstance().getReference("/user-apartments-images/")
...
private fun getProfileHomeImages(context: Context) {
        val fromId = FirebaseAuth.getInstance().uid
        val ref = FirebaseDatabase.getInstance().getReference("/user-apartments-images/$fromId")
...
//        Log.d("Receivenotification", "listenForNotifications $fromId")
        ...
        ref.addChildEventListener(object: ChildEventListener {
            ...
            override fun onChildAdded(p0: DataSnapshot, p1: String?) {
                ...
                adapter.add(ProfileHomePicsResultRow(context, p0.value.toString(), p0.key!!, adapter))
